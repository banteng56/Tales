...
from database_operations import load_last_k_text_messages, save_text_message, save_audio_message, load_messages, get_all_chat_history_ids, delete_chat_history
import sqlite3
config = load_config()
...
def main():
    ...
    if "db_conn" not in st.session_state:
        ...
        st.session_state.session_index_tracker = "new_session"
        st.session_state.db_conn = sqlite3.connect("coba1.db", check_same_thread=False)
    ...
    st.sidebar.image("robot.png",width=200)
