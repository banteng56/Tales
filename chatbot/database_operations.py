...
def get_db_connection_and_cursor():
    ...
    print("Getting cursor from database connection.")
...
def save_text_message(chat_history_id, sender_type, text):
    ...
    print(f"Saving text message to chat_history_id: {chat_history_id}")
...
def save_image_message(chat_history_id, sender_type, image_bytes):
    conn, cursor = get_db_connection_and_cursor()
    print(f"Saving image message to chat_history_id: {chat_history_id}")
...
def save_audio_message(chat_history_id, sender_type, audio_bytes):
    conn, cursor = get_db_connection_and_cursor()
    print(f"Saving audio message to chat_history_id: {chat_history_id}")
...
def load_messages(chat_history_id):
    conn, cursor = get_db_connection_and_cursor()
    print(f"Loading messages for chat_history_id: {chat_history_id}")
...
def load_last_k_text_messages(chat_history_id, k):
    conn, cursor = get_db_connection_and_cursor()
    print(f"Loading last {k} text messages for chat_history_id: {chat_history_id}")
...
def get_all_chat_history_ids():
    conn, cursor = get_db_connection_and_cursor()
    print("Getting all chat history IDs.")
...
def delete_chat_history(chat_history_id):
    conn, cursor = get_db_connection_and_cursor()
    print(f"Deleting chat history for chat_history_id: {chat_history_id}")
